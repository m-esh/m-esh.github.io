      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((item, i) => (
          <motion.button
            ...
            className="group relative overflow-hidden rounded-xl border border-border/60 bg-card/50 text-left backdrop-blur-sm transition-colors hover:border-border"
          >
            <div className="relative aspect-[4/3] overflow-hidden bg-background/40">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-background/0 opacity-0 backdrop-blur-[1px] transition-all duration-300 group-hover:bg-background/30 group-hover:opacity-100">
                <span className="inline-flex items-center gap-2 rounded-lg border border-border/60 bg-background/70 px-3.5 py-1.5 text-xs font-medium text-muted-foreground">
