...
import { GlassPrism } from "@/components/glass-prism";
...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center gap-12 px-6 lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-8">
        ...
        <GlassPrism
          ...
          className="animate-fade-up hidden h-[360px] w-[320px] shrink-0 lg:block"
        />
      </div>
