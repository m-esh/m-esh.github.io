...
const CARD_CHROME =
  "group relative flex flex-col overflow-hidden rounded-xl border border-border/60 bg-card/50 transition-[border-color] duration-300 hover:border-primary/40";
